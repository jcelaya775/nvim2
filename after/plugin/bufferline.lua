...
set_keymap("n", "<A-1>", "<CMD>lua require'bufferline'.go_to_buffer(1)<CR>", {})
set_keymap("n", "<A-2>", "<CMD>lua require'bufferline'.go_to_buffer(2)<CR>", {})
set_keymap("n", "<A-3>", "<CMD>lua require'bufferline'.go_to_buffer(3)<CR>", {})
set_keymap("n", "<A-4>", "<CMD>lua require'bufferline'.go_to_buffer(4)<CR>", {})
set_keymap("n", "<A-5>", "<CMD>lua require'bufferline'.go_to_buffer(5)<CR>", {})
set_keymap("n", "<A-6>", "<CMD>lua require'bufferline'.go_to_buffer(6)<CR>", {})
set_keymap("n", "<A-7>", "<CMD>lua require'bufferline'.go_to_buffer(7)<CR>", {})
set_keymap("n", "<A-8>", "<CMD>lua require'bufferline'.go_to_buffer(8)<CR>", {})
set_keymap("n", "<A-9>", "<CMD>lua require'bufferline'.go_to_buffer(9)<CR>", {})
set_keymap("n", "<A-10>", "<CMD>lua require'bufferline'.go_to_buffer(9)<CR>", {})
...
set_keymap("n", "<M-10>", "<CMD>lua require'bufferline'.go_to_buffer(9)<CR>", {})
